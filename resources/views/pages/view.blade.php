    ...
    <section class="dark:bg-coolGray-800 dark:text-coolGray-100">
        <div
            ...
            <div class="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
                ...
                <div
                    data-et-view=" MCIAFKKZaTaTaBcJPQORYPOHMQMSeRe:2  MCIAFKKZaTaTaBcJPQORYPOHMQMSeRe:3   MCIAFKKZaTaTaBcJPQORYPOHMQMSeRe:5  ">
                </div>
                <p>This double room has a electric kettle, flat-screen TV and minibar. The room offers private separate
                    bedrooms with a bathroom featuring a Jacuzzi.</p>
